...
class CategoryAdmin(admin.ModelAdmin):
    list_display = ("name", "slug", "level", "parent", "product_count_display", "commission_display", "is_active_display", "order", "created_at")
    list_editable = ("order", )
    ...
    fieldsets = (
        ('Basic Information', {
            'fields': ('name', 'slug', 'level', 'parent', 'description'),
...
class ProductAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('created_at', 'updated_at', 'views_count', 'sales_count', 'slug')
